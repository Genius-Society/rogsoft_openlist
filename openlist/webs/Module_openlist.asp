...
<head>
	...
	<script type="text/javascript">
		...
		function open_openlist_hint(itemNum) {
			...
			if (itemNum == 2) {
				statusmenu = "&nbsp;&nbsp;&nbsp;&nbsp;1. 此处显示当前openlist插件版本号及云端最新版本号, 其中插件版本号与openlist二进制程序版本号同号。<br/><br/>"
		...
		<table cellpadding="5" cellspacing="0" id="log_pannel_table" class="loadingBarBlock" style="width:960px"
			...
			<tr>
				<td height="100">
					...
					<div
						style="margin-left:15px;margin-right:15px;margin-top:10px;outline: 1px solid #3c3c3c;overflow:hidden">
						<textarea cols="50" rows="32" wrap="off" readonly="readonly" id="log_content_openlist"
							...
							<table width="760px" border="0" cellpadding="5" cellspacing="0" bordercolor="#6b8fa3"
								...
								<tr>
									<td bgcolor="#4D595D" colspan="3" valign="top">
										<div>&nbsp;</div>
										<div class="formfonttitle">OpenList <lable id="openlist_version"></lable>
										</div>
										...
										<div id="openlist_setting_pannel" style="margin-top:10px">
											<table width="100%" border="1" align="center" cellpadding="4"
												...
												<tr id="dashboard">
													<th><a onmouseover="mOver(this, 11)" onmouseout="mOut(this)"
															class="hintstyle" href="javascript:void(0);">关闭系统检测</a></th>
													<td>
														<input type="checkbox" id="openlist_disablecheck"
												...
												<tr id="dashboard">
													...
													<td>
														<input type="checkbox" id="openlist_watchdog"
															style="vertical-align:middle;">
													</td>
												</tr>
												<tr id="dashboard">
													...
													<td>
														<input type="checkbox" id="openlist_publicswitch"
												...
												<tr id="openlist_port_tr">
													...
													<td>
														<input type="text" id="openlist_port" style="width: 50px;"
															maxlength="5" class="input_3_table" autocorrect="off"
															autocapitalize="off"
															style="background-color: rgb(89, 110, 116);" value="5244">
														<span id="al_open_http_port"><input type="checkbox"
																id="openlist_open_http_port"
												...
												<tr>
													<th>延迟启动</th>
													<td>
														<input onkeyup="this.value=this.value.replace(/[^0-9]{1,3}/,'')"
															style="width:30px;" type="text" class="input_ss_table"
															id="openlist_delayed_start" name="openlist_token_expires_in"
															maxlength="3" autocorrect="off" autocapitalize="off"
															value="0">
														<span>秒</span>
													</td>
												</tr>
												<tr>
													...
													<td>
														<input
															onkeyup="this.value=this.value.replace(/[^1-9][^0-9]*/,'')"
															style="width:30px;" type="text" class="input_ss_table"
															id="openlist_token_expires_in"
															name="openlist_token_expires_in" maxlength="3"
															autocorrect="off" autocapitalize="off" value="48">
														<span>小时</span>
													</td>
												</tr>
												<tr>
													<th><a onmouseover="mOver(this, 12)" onmouseout="mOut(this)"
															class="hintstyle" href="javascript:void(0);">最大并发连接数</a>
													</th>
													<td>
														<input onkeyup="this.value=this.value.replace(/\D/g,'')"
															style="width:30px;" type="text" class="input_ss_table"
															id="openlist_max_connections"
															name="openlist_max_connections" maxlength="3"
															autocorrect="off" autocapitalize="off" value="0">
													</td>
												</tr>
												<tr id="al_url">
													<th><a onmouseover="mOver(this, 8)" onmouseout="mOut(this)"
															class="hintstyle" href="javascript:void(0);">网站URL
															(site_url)</a>
														<lable id="warn_url" style="color:red;margin-left:5px">
															<lable>
													</th>
													<td>
														<input type="text" id="openlist_site_url" style="width: 95%;"
															class="input_3_table" autocorrect="off" autocapitalize="off"
															style="background-color: rgb(89, 110, 116);" value="">
													</td>
												</tr>
												<tr id="al_cdn">
													<th><a onmouseover="mOver(this, 9)" onmouseout="mOut(this)"
															class="hintstyle" href="javascript:void(0);">静态资源CDN地址<lable
																id="warn_cdn" style="color:red;margin-left:5px">
																<lable></a></th>
													<td>
														<input type="text" id="openlist_cdn" style="width: 95%;"
															class="input_3_table" autocorrect="off" autocapitalize="off"
															style="background-color: rgb(89, 110, 116);" value="">
													</td>
												</tr>
												<tr id="al_https">
													...
													<td>
														<input type="checkbox" id="openlist_https"
															onchange="show_hide_element();"
															style="vertical-align:middle;" />
														<span id="warn_cert"
												...
												<tr id="al_https_port">
													...
													<td>
														<input type="text" id="openlist_https_port" style="width: 50px;"
															maxlength="5" class="input_3_table" autocorrect="off"
															autocapitalize="off"
															style="background-color: rgb(89, 110, 116);" value="5245">
														<span id="al_open_https_port"><input type="checkbox"
																id="openlist_open_https_port"
																style="vertical-align:middle;;margin-left:50px;">开放公网端口</span>
													</td>
												</tr>
												<tr id="al_force_https">
													...
													<td>
														<input type="checkbox" id="openlist_force_https"
															style="vertical-align:middle;" />
													</td>
												</tr>
												<tr id="al_cert">
													...
													<td>
														<input type="text" id="openlist_cert_file" style="width: 95%;"
															class="input_3_table" autocorrect="off" autocapitalize="off"
															style="background-color: rgb(89, 110, 116);" value=""
												...
												<tr id="al_key">
													...
													<td>
														<input type="text" id="openlist_key_file" style="width: 95%;"
															class="input_3_table" autocorrect="off" autocapitalize="off"
															style="background-color: rgb(89, 110, 116);" value=""
										...
										<div id="openlist_apply" class="apply_gen">
											<input class="button_gen" style="display: none;" id="openlist_apply_btn_1"
												onClick="save(1)" type="button" value="开启" />
											<input class="button_gen" style="display: none;" id="openlist_apply_btn_2"
												onClick="save(2)" type="button" value="重启" />
											<input class="button_gen" style="display: none;" id="openlist_apply_btn_3"
										...
										<div style="margin:10px 0 0 20px">
											...
											<li>如有不懂, 特别是 openlist 配置文件的填写, 请查看 <a href="https://www.oplist.org"
													target="_blank"><em>OpenList 官方文档</em></a>
											</li>
